...
Mapa_Parte1 <- leaflet(
  ...
  setView(lat = -15.013615209001625, lng = -50.317577612085536, zoom = 4) %>% 
  addPolygons(
    stroke = T, #Desenho dos polígonos (ordas) habilitado
    opacity = 1, #Opacidade máxima
    color = "black", #Cor dos polígonos
    weight = 0.5, #Espessira da linhas dos polígonos
    smoothFactor = 0.0, #Simplificação da polilinha do polígono
    fillOpacity = 1, #Opacidade máxima do preenchimento
    label = ~paste0('Mun: ', name, " | Taxa de mortalidade infantil: ", tx_mort_inf, '/ 1.000 n.v.'), #Conteúdo da etiqueta ao passar o mouse
