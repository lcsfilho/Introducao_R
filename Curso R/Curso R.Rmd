...
O [R Studio ](https://posit.co/) "é um software livre de ambiente de desenvolvimento integrado para R, uma linguagem de programação para gráficos e cálculos estatísticos."  `r RefManageR::Cite(referencias, "RStudio")`
